...
formulario.addEventListener("submit", (e) => {
    ...
    // Para limpiar todos los mensajes de error antes de revalidar
    ...
    let inputEmail = document.getElementById("email").value.trim(); // Se recomienda usar .trim()
    ...
    // Solo verificar credenciales si no hay errores de campos vacíos
    if (!hayErrores) {
